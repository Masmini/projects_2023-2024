...
<body>
    ...
    <h1>Pay with HaloPesa</h1>
    <form action="halopesa.php" method="POST">
        <label for="halopesa_number">HaloPesa Number:</label>
        <input type="text" id="halopesa_number" name="halopesa_number" placeholder="+255*********" pattern="\+255[0-9]{9}" required><br>
        <label for="amount">Amount:</label>
        <input type="text" id="amount" name="amount" step="0.01" value="<?php echo  '$'.$totalPrice ; ?>" readonly><br>
        <input type="submit" value="Pay with HaloPesa">
    </form>
<script>
