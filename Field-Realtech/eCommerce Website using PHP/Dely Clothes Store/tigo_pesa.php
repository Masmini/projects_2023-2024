...
<html>
<head>
    <title>Pay with Tigo Pesa</title>
    <style>
         body {
...
<body>
    ...
    <h1>Pay with Tigo Pesa</h1>
    <form action="tigo_pesa.php" method="POST">
    <label for="tigo_pesa_number">Tigo Pesa Number:</label>
        <input type="text" id="tigo_pesa_number" name="tigo_pesa_number"   placeholder="+255*********" pattern="\+255[0-9]{9}" required><br>
        <label for="amount">Amount:</label>
        <input type="text" id="amount" name="amount" step="0.01" value="<?php echo '$' . $totalPrice; ?>" readonly><br>
        <input type="submit" value="Pay with Tigo Pesa">
    </form>
<script>
