...
if (isset($_SESSION['customer_id'])) {
    // User is logged in, redirect to home2.php page
...
.offer{
    ...
    padding: 0;
    margin: 9px;
    box-shadow: 0 0 10px rgba(255, 255, 255, 0.5); /* Whitish box shadow */
}
.main_offer{
    flex: 1;
    padding: 50px;
...
<body>
    ...
    <nav>
    <ul>
    <li ><a title="View home page" style = " color: red;" href="home.php">HOME</a></li>
...
function redirectToShop(category) {
        // Redirect to shop.php and pass the category as a query parameter
