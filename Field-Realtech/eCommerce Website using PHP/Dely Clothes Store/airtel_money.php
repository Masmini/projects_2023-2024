...
<html>
<head>
    <title>Pay with Airtel-Money</title>
    <style>
        body {
...
<h1>Pay with Airtel Money</h1>
<form action="airtel_money.php" method="POST">
    <label for="airtel_money_number">Airtel Money Number:</label>
    <input type="text" id="airtel_money_number" name="airtel_money_number" placeholder="+255*********" pattern="\+255[0-9]{9}" required><br>
    <label for="amount">Amount:</label>
    <input type="text" id="amount" name="amount" step="0.01" value="<?php echo '$' . $totalPrice; ?>" readonly><br>
    <input type="submit" value="Pay with Airtel Money">
</form>
...
<script>
    document.querySelector("form").addEventListener("submit", function (event) {
        ...
        // Delay the redirection to toCart.php by 4 seconds
        setTimeout(function () {
            // Redirect to toCart.php
