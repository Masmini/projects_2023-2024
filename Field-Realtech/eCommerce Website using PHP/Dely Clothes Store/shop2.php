...
<header>
    ...
    <li><a title="Contact our customer support team" href="contact2.php">CONTACT US</a></li>
     <li ><a title="Shop items from our store " style=" color: red;" href="shop2.php">SHOP</a></li>
     <li><a href="unconfirmedCart2.php"><img src="images (4).png" alt="View Cart" height="30px" width="30px">CART</a></li>
